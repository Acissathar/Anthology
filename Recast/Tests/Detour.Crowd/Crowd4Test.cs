...
public class Crowd4Test : AbstractCrowdTest
{
    ...
    public void TestAgent1Quality2TVTA()
    {
        ...
        for (int i = 0; i < EXPECTED_A1Q2TVTA.Length; i++)
        {
            ...
            Assert.Equal(EXPECTED_A1Q2TVTA[i][0], ag.npos.X, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTA[i][1], ag.npos.Y, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTA[i][2], ag.npos.Z, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTA[i][3], ag.nvel.X, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTA[i][4], ag.nvel.Y, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTA[i][5], ag.nvel.Z, 0.001f);
        }
    }
    ...
    public void TestAgent1Quality2TVTAS()
    {
        ...
        for (int i = 0; i < EXPECTED_A1Q2TVTAS.Length; i++)
        {
            crowd.Update(1 / 5f, null);
            DtCrowdAgent ag = agents[2];
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][0], ag.npos.X, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][1], ag.npos.Y, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][2], ag.npos.Z, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][3], ag.nvel.X, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][4], ag.nvel.Y, 0.001f);
            Assert.Equal(EXPECTED_A1Q2TVTAS[i][5], ag.nvel.Z, 0.001f);
        }
    }
    ...
    public void TestAgent1Quality2T()
    {
        ...
        for (int i = 0; i < EXPECTED_A1Q2T.Length; i++)
        {
            crowd.Update(1 / 5f, null);
            DtCrowdAgent ag = agents[2];
            Assert.Equal(EXPECTED_A1Q2T[i][0], ag.npos.X, 0.00001f);
            Assert.Equal(EXPECTED_A1Q2T[i][1], ag.npos.Y, 0.00001f);
            Assert.Equal(EXPECTED_A1Q2T[i][2], ag.npos.Z, 0.00001f);
            Assert.Equal(EXPECTED_A1Q2T[i][3], ag.nvel.X, 0.00001f);
            Assert.Equal(EXPECTED_A1Q2T[i][4], ag.nvel.Y, 0.00001f);
            Assert.Equal(EXPECTED_A1Q2T[i][5], ag.nvel.Z, 0.00001f);
        }
    }
}