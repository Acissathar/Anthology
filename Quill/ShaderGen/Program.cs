...
public static class Program
{
    ...
    [
        ...
        new("scissorMat", "mat4", "float4x4"),
        new("scissorExt", "vec2", "float2"),
        new("brushMat", "mat4", "float4x4"),
        ...
        new("brushTextureMat", "mat4", "float4x4"),
        new("dpiScale", "float", "float"),
    ...
    private static int WriteCSharp(string? path, string ns, string vertex, string fragment,
                                   string blurVertex, string blurDown, string blurUp)
    {
